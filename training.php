                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="training" class="dropdown-item active">Training</a>
        ...
        <div class="container-fluid training overflow-hidden bg-light py-5">
            <div class="container py-5">
                <div class="section-title text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-5 mb-4">Get the Best Coaching Service Training with M25 Travel</h1>
                    <p class="mb-0">Enhance your language skills and test preparation with our comprehensive coaching programs. We offer expert training for IELTS, TOEFL, PTE, and OET to help you achieve your desired scores for visa and immigration requirements.</p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="training-item">
                            ...
                            <div class="training-content bg-secondary rounded-bottom p-4">
                                ...
                                <p class="text-white-50">Comprehensive IELTS preparation with expert instructors and proven strategies.</p>
                    ...
                    <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="training-item">
                            ...
                            <div class="training-content bg-secondary rounded-bottom p-4">
                                ...
                                <p class="text-white-50">Professional TOEFL training to achieve your target scores for university admissions.</p>
                                <a class="btn btn-secondary rounded-pill text-white p-0" href="#">Read More <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="training-item">
                            ...
                            <div class="training-content bg-secondary rounded-bottom p-4">
                                ...
                                <p class="text-white-50">Expert PTE Academic coaching with computer-based test preparation techniques.</p>
                                <a class="btn btn-secondary rounded-pill text-white p-0" href="#">Read More <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="training-item">
                            ...
                            <div class="training-content bg-secondary rounded-bottom p-4">
                                ...
                                <p class="text-white-50">Specialized OET training for healthcare professionals seeking international opportunities.</p>
                                <a class="btn btn-secondary rounded-pill text-white p-0" href="#">Read More <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
