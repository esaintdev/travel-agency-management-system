...
try {
    ...
    $stmt = $db->prepare("
        ...
        WHERE p.invoice_id = ? AND p.payment_status = 'completed'
    ...
    $_SESSION['error'] = "Error loading invoice details.";
    header('Location: admin-invoices.php');
    exit();
}
    ...
    <div class="invoice-container">
        ...
        <div class="invoice-meta">
            ...
            <div class="client-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo htmlspecialchars($invoice['full_name']); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Reference ID:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($invoice['client_ref']); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Email:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($invoice['client_email']); ?></span>
                </div>
                <?php if ($invoice['visa_type']): ?>
                <div class="detail-row">
                    <span class="detail-label">Visa Type:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($invoice['visa_type']); ?></span>
                </div>
                <?php endif; ?>
                <?php if ($invoice['address']): ?>
                <div class="detail-row">
                    <span class="detail-label">Address:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($invoice['address']); ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="payment-item">
                ...
                <div style="font-size: 14px; color: #666;">
                    ...
                    <?php if ($payment['processed_by_name']): ?>
                        <div>Processed by: <?php echo htmlspecialchars($payment['processed_by_name']); ?></div>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; ?>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 20px; font-size: 12px;">
                This invoice was generated on <?php echo date('F d, Y \a\t g:i A'); ?>
            </p>
        </div>
    </div>
