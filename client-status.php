...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top px-4 px-lg-5 py-lg-0">
        <a href="/" class="navbar-brand p-0">
            <h4 class="text-primary m-0"><i class="fas fa-globe-americas me-3"></i>M25 Travel & Tours Agency</h4>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="client-documents.php" class="nav-item nav-link"><i class="fas fa-file-upload me-1"></i>Documents</a>
                <a href="client-profile.php" class="nav-item nav-link"><i class="fas fa-user me-1"></i>Profile</a>
                <a href="client-status.php" class="nav-item nav-link active"><i class="fas fa-info-circle me-1"></i>Application Status</a>
